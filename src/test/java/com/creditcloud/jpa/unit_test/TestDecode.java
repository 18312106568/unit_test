...
//      System.out.println("0.123".replaceAll("^([1-9])(\\d{3}.*$)","$1$2"));
 //       System.out.println("3123".replaceAll("([34]*)(1|2)(\\1)", "$2"));
    ...
    public void testGson1(){
        Gson gson = new Gson();
        TestGsonC gsonC = new TestGsonC();
        gsonC.setId(System.currentTimeMillis());
        gsonC.setTime(new Date());
        System.out.println(gson.toJson(gsonC));
        String gsonStr = "{\"id\":1564993950865,\"time\":\"Aug 5, 2019 4:32:30 PM\"}";
        TestGsonC gsonC1 = gson.fromJson(gsonStr,TestGsonC.class);
        System.out.println(gsonC1);
    }

    @Data
    public static class TestGsonC{
        private Long id;
        private Date time;
    }
