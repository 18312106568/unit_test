...
package com.creditcloud.jpa.unit_test.bigData.kafka.kafka;

import com.creditcloud.jpa.unit_test.bigData.kafka.event.Event;
import com.creditcloud.jpa.unit_test.bigData.kafka.generator.StandaloneThreadedGenerator;
...
public class KafkaStandaloneGenerator extends StandaloneThreadedGenerator {
	...
	public static final String BROKER_ADDRESS = "192.168.11.207:9092";
