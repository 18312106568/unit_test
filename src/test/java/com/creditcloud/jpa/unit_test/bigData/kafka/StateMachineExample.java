...
package com.creditcloud.jpa.unit_test.bigData.kafka;

import com.creditcloud.jpa.unit_test.bigData.kafka.dfa.State;
import com.creditcloud.jpa.unit_test.bigData.kafka.event.Alert;
import com.creditcloud.jpa.unit_test.bigData.kafka.event.Event;
import com.creditcloud.jpa.unit_test.bigData.kafka.generator.EventsGeneratorSource;
import com.creditcloud.jpa.unit_test.bigData.kafka.kafka.EventDeSerializer;
...
public class StateMachineExample {
	...
	public static void main(String[] args) throws Exception {
		...
		if (params.has("kafka-topic")) {
			...
			String brokers = params.get("brokers", "192.168.11.207:9092");
